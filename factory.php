 ...
 <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
     <div class="carousel-inner">
         <div class="carousel-item active">
             <img class="d-block w-100 img-fluid" src="images/fac-ban.png" alt="First slide">
 ...
 <section class="fac-sec">
     <div class="container">
         <div class="fac-head">
             <h2>Factory View</h2>
             <h5>Legal Information & Notices</h5>
         </div>
         <div class="fac-para">
             ...
             <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                 <div class="fac-law">
                     ...
                     <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                         ...
                         culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet</p>
                 </div>
             </div>
             <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                 <div class="fac-img">
                     <img class="img-fluid" src="images/fac1.png" alt="">
                 </div>
         ...
         <div class="row">
             <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                 <div class="fac-img">
                     <img class="img-fluid" src="images/fac2.png" alt="">
                 </div>
             </div>
             <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                 <div class="fac-law">
                     ...
                     <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                         ...
                         sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore
                         magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                         aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in. </p>
     ...
     <div class="container">
         <div class="row">
             <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                 <div class="collection">
                     <div class="collec-img">
                         <img class="img-fluid" src="images/pic1.png" alt="">
                     </div>
             ...
             <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                 <div class="collection">
                     <div class="collec-img">
                         <img class="img-fluid" src="images/pic2.png" alt="">
                     </div>
                     <div class="collec-text">
                         <h4>24 INCH & 18 INCH</h4>
                         <h3>DELSEY Paris Helium</h3>
             ...
             <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                 <div class="collection">
                     <div class="collec-img">
                         <img class="img-fluid" src="images/pic3.png" alt="">
                     </div>
                     <div class="collec-text">
                         <h4>24 INCH & 18 INCH</h4>
                         <h3>DELSEY Paris Helium</h3>
             ...
             <div class="row">
                 <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                     <div class="collection">
                         <div class="collec-img">
                             <img class="img-fluid" src="images/pic4.png" alt="">
                         </div>
                         <div class="collec-text">
                             <h4>24 INCH & 18 INCH</h4>
                             <h3>DELSEY Paris Helium</h3>
                 ...
                 <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                     <div class="collection">
                         <div class="collec-img">
                             <img class="img-fluid" src="images/pic5.png" alt="">
                         </div>
                         <div class="collec-text">
                             <h4>24 INCH & 18 INCH</h4>
                             <h3>DELSEY Paris Helium</h3>
                 ...
                 <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                     <div class="collection">
                         <div class="collec-img">
                             <img class="img-fluid" src="images/pic6.png" alt="">
                         </div>
                         <div class="collec-text">
                             <h4>24 INCH & 18 INCH</h4>
                             <h3>DELSEY Paris Helium</h3>
