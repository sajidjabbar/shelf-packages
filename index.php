        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                    <div class="collection">
                        <div class="collec-img">
                            <img class="img-fluid wow animate__animated animate__slideInLeft" src="images/pic4.png"
                                alt="">
                        </div>
                        <div class="collec-text">
                            <h4>24 INCH & 18 INCH</h4>
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                    <div class="collection">
                        <div class="collec-img">
                            <img class="img-fluid wow animate__animated animate__slideInDown" src="images/pic5.png"
                                alt="">
                        </div>
                        <div class="collec-text">
                            <h4>24 INCH & 18 INCH</h4>
                ...
                <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4">
                    <div class="collection">
                        <div class="collec-img">
                            <img class="img-fluid wow animate__animated animate__slideInRight" src="images/pic6.png"
                                alt="">
                        </div>
                        <div class="collec-text">
                            <h4>24 INCH & 18 INCH</h4>
            ...
            <div class="col-md-6 col-sm-6 col-sm-6 col-xs-6 col-lg-6 for-back">
                <div class="custom-all">
                    ...
                    <div class="custom-arrow">
                        <h3> <span><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    class="bi bi-arrow-left" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                        d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
                                </svg></span> Step 01 <span><svg xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <div class="col-md-6 col-sm-6 col-sm-6 col-xs-6 col-lg-6">
                <div class="custom-case">
                    <div class="custom-text">
                        ...
                        <a id="minus" onclick="changeImage1()"><img class="img-fluid mb-2" src="images/iconplus.png" alt=""></a>
                        <h4>Click image <br> to rotate</h4>

                    </div>
                    <div class="custom-img">
                        <img id="myImage" onclick="changeImage()"
                            class="minus wow animate__animated animate__slideInRight" src="images/case.png" alt="">
                    </div>
                </div>
            </div>
        </div>
